...
class LinkEntity {
     ...
     */
    _negotiateClaim({ abortSignal, setTokenRenewal, timeoutInMs }) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._context.cbsSession.isOpen()) {
                yield coreAmqp.defaultCancellableLock.acquire(this._context.cbsSession.cbsLock, () => {
            ...
            yield coreAmqp.defaultCancellableLock.acquire(this._context.negotiateClaimLock, () => {
...
class ManagementClient extends LinkEntity {
    ...
    _init({ abortSignal, timeoutInMs }) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            try {
                if (!this._isMgmtRequestResponseLinkOpen()) {
                    // Wait for the connectionContext to be ready to open the link.
                    yield this._context.readyToOpenLink();
                    yield this._negotiateClaim({ setTokenRenewal: false, abortSignal, timeoutInMs });
                    const rxopt = {
                    ...
                    this._mgmtReqResLink = yield coreAmqp.RequestResponseLink.create(this._context.connection, sropt, rxopt, { abortSignal });
            ...
            try {
                ...
                const sendOperationPromise = () => tslib.__awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!this._isMgmtRequestResponseLinkOpen()) {
                        ...
                        try {
                            yield coreAmqp.defaultCancellableLock.acquire(this.managementLock, () => {
    ...
    function create(config, tokenCredential, options) {
                ...
                return tslib.__awaiter(this, void 0, void 0, function* () {
                    try {
                        if (this.connection.isOpen()) {
                            ...
                            yield Promise.all(Object.keys(connectionContext.senders).map((name) => {
                                var _a;
                            ...
                            yield Promise.all(Object.keys(connectionContext.receivers).map((name) => {
                                var _a;
                            ...
                            yield ((_a = this.managementSession) === null || _a === void 0 ? void 0 : _a.close());
        ...
        const onDisconnected = (context) => tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield ((_a = connectionContext.cbsSession) === null || _a === void 0 ? void 0 : _a.close().catch(() => {
                    /* error already logged, swallow it here */
                }));
                // Close the management session to ensure all the event handlers are released.
                yield ((_b = connectionContext.managementSession) === null || _b === void 0 ? void 0 : _b.close().catch(() => {
                    /* error already logged, swallow it here */
                }));
...
class EventHubReceiver extends LinkEntity {
     ...
     * @hidden
     */
    initialize({ abortSignal, timeoutInMs }) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            try {
                if (!this.isOpen() && !this.isConnecting) {
                    ...
                    this._receiver = yield this._context.connection.createReceiver(Object.assign(Object.assign({}, options), { abortSignal }));
                    this.isConnecting = false;
...
class EventHubSender extends LinkEntity {
    ...
    getMaxMessageSize(options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            const sender = yield this._getLink(options);
    ...
    _trySendBatch(rheaMessage, options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            const sendEventPromise = () => tslib.__awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const delivery = yield sender.send(rheaMessage, undefined, 0x80013700, {
                        abortSignal
                    });
    ...
    _getLink(options = {}) {
        return tslib.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield coreAmqp.retry(config);
            }
            catch (err) {
                const translatedError = coreAmqp.translate(err);
