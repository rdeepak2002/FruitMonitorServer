        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!this._isMgmtRequestResponseLinkOpen()) {
                    ...
                    this._mgmtReqResLink = yield RequestResponseLink.create(this._context.connection, sropt, rxopt, { abortSignal });
            ...
            try {
                ...
                const sendOperationPromise = () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!this._isMgmtRequestResponseLinkOpen()) {
                        ...
                        try {
                            yield defaultCancellableLock.acquire(this.managementLock, () => {
